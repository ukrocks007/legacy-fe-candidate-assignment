...
const MessageSigner: React.FC = () => {
  ...
  const handleVerifySignature = async (signedMsg: SignedMessage) => {
    const result = await verifySignature(signedMsg.message, signedMsg.signature);
    setVerificationResult(result);
  };
      ...
      {verificationResult && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">
              <strong className="text-gray-800 dark:text-white">Original Message:</strong>
              ...
              <div key={index} className="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">"{signedMsg.message}"</p>
                  </div>
                  
                  <div>
                    <strong className="text-sm text-gray-700 dark:text-gray-300">Address:</strong>
                  ...
                  <div>
                    <strong className="text-sm text-gray-700 dark:text-gray-300">Signature:</strong>
                    <p className="font-mono text-xs text-gray-600 dark:text-gray-400 break-all">
                      {signedMsg.signature}
                    </p>
                  </div>
