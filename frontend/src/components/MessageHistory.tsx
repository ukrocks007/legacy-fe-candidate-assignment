...
const MessageHistory: React.FC<MessageHistoryProps> = ({ signedMessages, clearHistory }) => {
    return (
                            ...
                            >
                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2 gap-2">
                                    ...
                                    {msg.isValid !== undefined && (
                                        <div className={`text-xs px-2 py-1 rounded-full whitespace-nowrap self-start ${msg.isValid
